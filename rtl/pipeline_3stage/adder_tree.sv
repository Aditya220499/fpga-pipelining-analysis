...
(
    ...
    logic [9:0] sum_abcd_comb;
    logic [9:0] sum_efgh_comb;

    logic [9:0] sum_abcd_reg;
    logic [9:0] sum_efgh_reg;
    ...
    begin
        ...
        sum_abcd_comb = sum_ab_reg + sum_cd_reg;
        sum_efgh_comb = sum_ef_reg + sum_gh_reg;

        //-----------------------------
        // Level-3
        //-----------------------------

        sum_comb = sum_abcd_reg + sum_efgh_reg;
    ...
    begin
        ...
        sum_abcd_reg <= sum_abcd_comb;
        sum_efgh_reg <= sum_efgh_comb;
